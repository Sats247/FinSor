...
```
**Note**: The Groq API key needs to be valid for the Genie chat and diagnostic checks to work.
...
- **AI Research Genie**: Groq-powered RAG (llama-3.3-70b-versatile) for Indian equity.
...
---
Built with Flask, Vanilla JS, and Groq (Llama 3.3 70B).
